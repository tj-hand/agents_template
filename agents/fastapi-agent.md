...
"Database Agent [EXECUTE #45]: add last_login field"
...
```
Issue #45: "User profile endpoint"
...
7. Write tests
8. Commit: "feat: user profile endpoint #45"
...
```
"FastAPI Agent [DIRECT]: create quick test endpoint"
...
4. Use for: Emergency hotfix, prototype, experiment
