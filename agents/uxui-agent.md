...
Both commit to: feat/45-login-page
```

**Pattern 2 - Component improvement:**
```
Issue #67: "Add loading to buttons"
...
```
Issue #45: "Create login page"
Assigned: UX/UI + Vue

Actions:
1. Check /ui/ for existing components
2. Create LoginLayout.vue (structure, ARIA, slots)
3. Test responsive + accessibility
4. Commit: "feat(ui): login layout #45"
5. Signal: "Vue Agent: layout ready for logic"
```
...
```
"UX/UI Agent [DIRECT]: test component styling"
...
4. Use for: Design prototype, quick test, style experiment
...
"UX/UI Agent [CONSULT]: check accessibility #45"
