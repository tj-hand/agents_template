...
```
PM Agent: "Database Agent [EXECUTE #45]: create users table"
...
5. Commit: "feat: users table migration #45"
6. PR via Git Agent
```
...
```
"Database Agent [DIRECT]: test migration for feature X"
...
4. Use for: Test migration, prototype schema, experiment
...
**Delegates:**
- Schema design decisions (if unclear) → PM Agent
